...
$authHelper = new AuthHelper($client, $storage, $current_page_URL2);
...
if ($_GET['action'] == 'revoke') {
  ...
  if ($authHelper->isAuthorized()) {
    ...
    if ($_GET['demo'] == 'hello') {
      ...
      $demo = new coreReportingApiReference($analytics, $current_page_URL2);
...
$revokeUrl = $current_page_URL2 . '&action=revoke';

$helloAnalyticsDemoUrl = $current_page_URL2 . '&demo=hello';
